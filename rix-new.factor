...
RIX-TYPE: rix-resolve value>> "symbol" <val> over current-namespace>> env-get [ "unknown symbol" eval-error ] unless* ;
...
RIX-TYPE: rix-symbol over current-namespace>> env-get [ "unknown symbol" eval-error ] unless* push-token f ;
