...
: env-deep-clone ( env -- env ) clone [ clone [ [ clone ] bi@ ] assoc-map ] change-bindings dup parent>> [ [ env-deep-clone ] change-parent ] when ;
...
: global-env ( -- env )
    ...
    } clone [ [ clone ] bi@ ] assoc-map rix-env boa clone
    ;
        ...
        [
            ...
            [
                [ lex-str >>tokens eval-all dup results>> dup empty? not [ last pprint-rix-value "\n" write t ] [ drop t ] if ] when*% ] [ [ "error" <val> pprint-rix-value "\n" write ] with-string-writer
                                                                                                                                           print-callstack
                                                                                                                                           COLOR: red
                                                                                                                                           foreground associate format ] recover ] loop drop ;
